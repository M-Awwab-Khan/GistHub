...
export function PricingSection() {
  const monthlyPlans = [
    ...
    },
    {
      name: "Team",
      price: "$49",
      description: "For development teams with advanced needs.",
      features: [
        "Everything in Pro",
        "Team management",
        "Advanced statistics",
  ...
  return (
    <section id="pricing" className="w-full py-20 md:py-32 bg-muted/30 relative overflow-hidden flex flex-col items-center">
