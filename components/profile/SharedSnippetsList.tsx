...
import { Clock, Code2, Edit, UserCircleIcon } from "lucide-react";
import CodeBlock from "./CodeBlock";

interface SharedSnippetsListProps {
...
export default function SharedSnippetsList({
  sharedSnippets,
}: SharedSnippetsListProps) {
    ...
    return (
      <div className="col-span-full text-center py-12">
        ...
        <p className="text-gray-500 mb-4">
          It seems that no one has shared any snippets with you yet.
        </p>
      </div>
    );
  }
